...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR    :  FSOCIETY "$i"                 "
echo $i""$pu"  WhatsApp  :  0557254790  "$i"              "
echo $i""$pu"  GMAIL     :  oanonymous85@gmail.com "$i"   "
echo $i""$pu"  YOUTUBE   :  FSOCIETY ARAB   "$i"          "
echo $i""$pu"  INSTAGRAM :  Shadow hacker Dz"$i"          "
echo $i""$pu"  Twitter   :  ShadowDz5        "$i"         "
echo $pur"==================="$cy" ============================="
...
echo "  |  __|  \___  \ | | | | | |     | | |  __|    | |     \  /   "
echo "  | |      ___| | | |_| | | |___  | | | |___    | |     / /    "
echo "  |_|     /_____/ \_____/ \_____| |_| |_____|   |_|    /_/MOUSSA"  
...
sleep 2
echo $ku"Facebook :"$i" moussa.ufonet"
echo $ku"YouTube  :"$i"Shadow hacker Dz "
echo $ku"WhatsApp :"$i" MRX"
sleep 2
